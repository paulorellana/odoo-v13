...
def build_guia_shipment(documento,transportes):
    ...
    elif documento['motivoTraslado'] in ["13"]:
        shipment.handling_instructions = documento.get('descripcionMotivoTraslado', None)
    ...
    despatch = Shipment.Despatch(address_id = documento['salidaUbigeo'],
                                ...
                                numero_anexo = documento.get("salidaAnexo",None),
                                numero_identificacion = documento.get("llegadaRucEstablecimiento",None))
    shipment.delivery_address = Shipment.DeliveryAddress(address_id = documento['entregaUbigeo'],
                                                         ...
                                                         despatch = despatch,
                                                         numero_anexo = documento.get("entregaAnexo",None),
                                                         numero_identificacion= documento.get("partidaRucEstablecimiento",None))
