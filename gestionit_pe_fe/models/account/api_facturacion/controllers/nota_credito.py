...
def build_nota_credito(data):
    ...
    line_extension_amount = LineExtensionAmount(amount=mntNeto + mntExe + mntExo + mntExportacion, currencyID=tipoMoneda)
    ...
    for line in detalle:
        ...
        # 9996 -	Gratuito
        if cod_afectacion_igv in ["11", "12", "13", "14", "15", "16",  "21", "31", "32", "33", "34", "35", "36","37"]:
            tax_scheme = TaxScheme("9996", "GRA", "FRE")
