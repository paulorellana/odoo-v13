...
def build_detalle(detalle):
    ...
    mntGrat = detalle.get("mntGrat")
    mntExp = detalle.get("mntExp")
    ...
    if mntExp:
        doc_line.billing_payments.append(
            SummaryDocumentsLine.BillingPayment(mntExp, "04",currencyID=moneda))
        
    # Gratuito
    if mntGrat:
        doc_line.billing_payments.append(
            SummaryDocumentsLine.BillingPayment(mntGrat, "05",currencyID=moneda))
