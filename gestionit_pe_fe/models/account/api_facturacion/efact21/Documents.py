...
class Factura(Xmleable):
    def __init__(self, ubl_extensions=None, ubl_version="2.1", id=None,
        ...
        self.allowance_charge_anticipo = allowance_charge_anticipo
    ...
    def validate(self, errs, obs):
        ...
        assert self.allowance_charge_anticipo is None or type(self.allowance_charge_anticipo) == AllowanceCharge
    ...
    def generate_doc(self):
        ...
        #Anticipo
        if self.allowance_charge_anticipo:
            self.doc.appendChild(self.allowance_charge_anticipo.get_document())
