...
class AllowanceCharge(Xmleable):
    def __init__(self, charge_indicator, allowance_charge_reason_code, amount, base_amount, currency_id,multiplier_factor_numeric=None):
        self.charge_indicator = charge_indicator
        self.allowance_charge_reason_code = allowance_charge_reason_code
        self.multiplier_factor_numeric = multiplier_factor_numeric
        self.amount = amount
    ...
    def fix_values(self):
        ...
        if self.allowance_charge_reason_code in ["00", "01", "02", "04","62"]:
    ...
    def validate(self, errs, obs):
        ...
        assert self.multiplier_factor_numeric is None or type(self.multiplier_factor_numeric) == MultiplierFactorNumeric, "La tasa de descuento tiene un formato diferente a real."
    ...
    def generate_doc(self):
        ...
        if self.multiplier_factor_numeric:
